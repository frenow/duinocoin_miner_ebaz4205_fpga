...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports FCLK_CLK0_0] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins top_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins top_0/rst_n]
  ...
  connect_bd_net -net top_0_uart_tx [get_bd_ports uart_tx_0] [get_bd_pins top_0/uart_tx]
  connect_bd_net -net uart_rx_0_1 [get_bd_ports uart_rx_0] [get_bd_pins top_0/uart_rx]
